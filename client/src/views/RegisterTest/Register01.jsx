    ...
    const handleSignUpClick = (e) => {
        ...
        if (selectedOption === 'Student') {
            ...
            if (
                ...
                .then(res => {
                    console.log(res);
                    setAlertMessage("Register completed");
            ...
            if (
                ...
                console.log('add to instuctor table')
                console.log("Inputs:", values);
                Axios.post('http://localhost:3001/Register01', {
                    userType: "Instructor",
                    name: values.Name,
        ...
        <div className="BgForm">
            ...
            <div className="Content">
                ...
                <div className="RegisterForms">
                    ...
                    <div className="RegisterDataForm">
                        <div className="registerForm">
                            ...
                            {selectedOption === 'Instructor' && (console.log('Select Instructor') || <InstructorForm onChange={handleInputChange} errors={errors}/>)}
                        </div>
                    </div>
                ...
                <div className="SignUpButton">
                    <Button onClick={handleSignUpClick} disabled={!isChecked} label={"Sign Up"} />
                </div>
            </div>
