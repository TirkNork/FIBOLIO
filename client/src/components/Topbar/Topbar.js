...
import Fibolio from "../../assets/images/Fibolio.png";
    ...
    <nav className="navbar">
      ...
      <div className="dropdown-menu">
        ...
        {dropdownOpen && (
          <div className="dropdown-content">
            ...
            <Link to="/Signin" onClick={() => setDropdownOpen(false)}>
              Logout
            </Link>
          </div>
        )}
      ...
      {isMenuOpen ? (
        <ul className="responsive-navbar">
          <li>
            <Link to="/PersonalInformation" onClick={toggleMenu}>
              Profile
            </Link>
          </li>

          <li>
            <Link to="/Course" onClick={toggleMenu}>
              Course
            </Link>
          </li>
          ...
          <li>
            <Link to="/Competency" onClick={toggleMenu}>
              Competency
            </Link>
          </li>
